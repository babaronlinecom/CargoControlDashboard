...
import { NewShipmentDialog } from "@/components/dialogs/new-shipment-dialog";
...
export default function Shipments() {
  ...
  const {
    ...
    queryFn: async () => {
      const response = await apiRequest(
        "GET",
        `/api/shipments?status=${statusFilter}&dateRange=${dateFilter}`,
        undefined
      );
  ...
  const paginatedShipments =
    filteredShipments?.slice(startIndex, endIndex) || [];
  ...
  return (
    <DashboardLayout title="Shipment Management">
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <CardDescription>
                Manage, track and update your shipments
              </CardDescription>
            </div>
            <Button
              className="mt-4 md:mt-0 bg-primary"
              onClick={() => setIsNewShipmentDialogOpen(true)}
            >
          ...
          <div className="flex items-center justify-between space-x-2 py-4">
            <div className="text-sm text-muted-foreground">
              ...
              <span className="font-medium">
                {totalShipments > 0 ? startIndex + 1 : 0}
              </span>{" "}
      ...
      <NewShipmentDialog
        isOpen={isNewShipmentDialogOpen}
        onClose={() => setIsNewShipmentDialogOpen(false)}
      />
              ...
              <TabsContent value="tracking">
                <div className="py-4">
                  <div className="space-y-4">
                    ...
                    <Button className="w-full">Track via Aramex</Button>
                  </div>
                </div>
              </TabsContent>
                  ...
                  <div className="border-t pt-4">
                    ...
                    selectedShipment.notes.length > 0 ? (
                      ...
                      <p className="text-gray-500 text-sm">
                        No notes for this shipment yet
                      </p>
                    )}
                  </div>
                </div>
